...
# Cambiamos al directorio en el que vamos a trabajar
setwd("UCI HAR Dataset")

# leemos la carpeta train
...
# leemos el archivo de features
features <- read.table("./features.txt") 

# leemos el archivo de activity labels
activity_labels <- read.table("./activity_labels.txt") 

# unimos los archivos de training y test 
x_total   <- rbind(x_train, x_test)
y_total   <- rbind(y_train, y_test) 
sub_total <- rbind(sub_train, sub_test) 

# desviaciion estandar y media
...
# convertimos activities y subjects en factors 
